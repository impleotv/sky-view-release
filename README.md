...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **SkyView (Linux x64)** |  v1.2.3 | [sky-view-install.tar.gz](https://github.com/impleotv/sky-view-release/releases/download/v1.2.3/sky-view-install.tar.gz)  | 
...
```bash
wget https://github.com/impleotv/sky-view-release/releases/download/v1.2.3/sky-view-install.tar.gz
...
|          | Version             | Download link                                                           | 
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **SkyView (Linux x64) .deb** |  v1.2.3 | [sky-view_v1.2.3_amd64.deb](https://github.com/impleotv/sky-view-release/releases/download/v1.2.3/sky-view_1.2.3_amd64.deb)  | 


- Download the `.deb` package:  
```bash
wget https://github.com/impleotv/sky-view-release/releases/download/v1.2.3/sky-view_1.2.3_amd64.deb
```
- Install the package:  
```bash
sudo dpkg -i sky-view_1.2.3_amd64.deb
