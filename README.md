...
```bash
wget https://github.com/impleotv/sky-view-release/releases/download/v1.6.7/sky-view-install.tar.gz
...
|          | Version             | Download link                                                           | 
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **SkyView (Linux x64) .deb** |  v1.6.7 | [sky-view_v1.6.7_amd64.deb](https://github.com/impleotv/sky-view-release/releases/download/v1.6.7/sky-view_1.6.7_amd64.deb)  | 


- Download the `.deb` package:  
```bash
wget https://github.com/impleotv/sky-view-release/releases/download/v1.6.7/sky-view_1.6.7_amd64.deb
```
- Install the package:  
```bash
sudo dpkg -i sky-view_1.6.7_amd64.deb
...
|          | Version             | Download link                                                           | 
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **SkyView (Windows x64)** |  v1.6.7 | [sky-view-win-installer.zip](https://github.com/impleotv/sky-view-release/releases/download/v1.6.7/sky-view-win-installer.zip)  | 
